...
const TEAM_MEMBERS: TeamMemberMeta[] = [
  ...
  { name: 'Solomon Raj', role: 'CRA Specialist', id: 'usr_cra_solomon', avatarBg: 'bg-blue-600', badge: 'EMP' },
  { name: 'Charan Kumar', role: 'CRA Specialist', id: 'usr_cra_charan', avatarBg: 'bg-teal-600', badge: 'EMP' },
